...
flags.DEFINE_bool(
    "xcode_only", False,
    "Build iOS xcode project instead of iOS testapp.")
...
def run_xcodebuild(dir_helper, ios_config, device_type):
  ...
  _run(
      xcodebuild.get_args_for_build(
          path=os.path.join(dir_helper.output_dir, "testapp_xcode_"+_IOS_SDK[device_type], dir_helper.xcode_name),
